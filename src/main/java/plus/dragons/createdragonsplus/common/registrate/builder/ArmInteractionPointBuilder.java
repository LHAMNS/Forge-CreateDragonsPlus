...
public class ArmInteractionPointBuilder<T extends ArmInteractionPointType, P> extends AbstractBuilder<ArmInteractionPointType, T, P, ArmInteractionPointBuilder<T, P>> {
    ...
    public ArmInteractionPointBuilder(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceKey<Registry<ArmInteractionPointType>> registryKey, Supplier<T> factory) {
