...
public class CDPFanScenes {
    public static void bulkColoring(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(10);
        ItemStack dough = new ItemStack(AllItems.DOUGH.get());
        ...
        var sheep = scene.world.createEntity(level -> {
            ...
            Vec3 p = new Vec3(pos.getX() + 0.5, pos.getY(), pos.getZ() + 0.5);
            s.setPos(p.x, p.y, p.z);
            s.xo = p.x;
            s.yo = p.y;
            s.zo = p.z;
            s.animationSpeedOld = 0;
            s.animationSpeed = 1;
            s.animationPosition = 0;
            s.yRotO = 210;
            s.setYRot(210);
            s.yHeadRotO = 210;
            s.yHeadRot = 210;
        ...
        var armorStand = scene.world.createEntity(level -> {
            ...
            as.setPos(pos.getX() + 0.5, pos.getY(), pos.getZ() + 0.5);
        ...
        scene.world.modifyEntity(armorStand, it -> {
            ...
            for (var slot : slots) {
                ...
                var dyedArmor = DyeItem.byColor(DyeColor.LIME).dyeArmor(armor, List.of(DyeItem.byColor(DyeColor.LIME)));
    ...
    public static void bulkFreezing(SceneBuilder scene, SceneBuildingUtil util) {
    ...
    public static void bulkEnding(SceneBuilder scene, SceneBuildingUtil util) {
